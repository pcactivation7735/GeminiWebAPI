...
def run_install(check_mode=False):
    if check_mode:
        ...
        print_step("[DRY-RUN] System Google Chrome detection (no Chromium install required)")
        return True
    ...
    print_step("Browser Runtime: Using host system Google Chrome (No Playwright Chromium download needed)")

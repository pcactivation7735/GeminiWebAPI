...
try:
    ...
    if exc.name == "playwright":
        ...
        print("\nNote: No Chromium download is required because this fork uses")
        print("your machine's pre-installed Google Chrome.\n")
        print("Then run:\n")
...
async def verify_login():
    ...
    try:
        ...
        print("RUNTIME: System Google Chrome (Installed on Host Machine)")
        print("="*60)
        print(f"Auth State Directory: {os.path.dirname(resolved_path)}")
        print(f"Target State File   : {resolved_path}")
        print("-"*60)
        print("Navigating to https://gemini.google.com/app using installed Chrome...")
        
        await page.goto("https://gemini.google.com/app")
        
        print("\nINSTRUCTIONS:")
        print("1. Log in to your Google account in the Chrome browser window.")
